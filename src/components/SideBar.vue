  ...
  <div class="header">
    <ul class="nav mt-3 flex-column justify-items-center">
      ...
      <li data-v-869d4650="" class="nav-item position-relative">
        <a data-v-869d4650="" href="/es/cursos" class="nav-link" target="_self"
          ><svg
            data-v-869d4650=""
            viewBox="0 0 16 16"
            width="1em"
      ...
      <li data-v-869d4650="" class="nav-item position-relative">
        <a
          ...
          ><svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="bi-chat-text mx-2 b-icon bi"
          >
            <g data-v-869d4650="">
              <path
      ...
      <li data-v-869d4650="" class="nav-item position-relative">
        <a data-v-869d4650="" href="/es/premios" class="nav-link" target="_self"
          ><svg
            data-v-869d4650=""
            viewBox="0 0 16 16"
            width="1em"
